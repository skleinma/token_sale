...
//  var tokensAvailable = 750000000000000000000000; // 750K with 18 digits
  var numberOfTokens;
  ...
  it('ends token sale', function() {
    return DappToken.deployed().then(function(instance) {
      ...
      // ORIG //balance = web3.eth.getBalance(tokenSaleInstance.address)
      // ORIG //assert.equal(balance.toNumber(), 0);
